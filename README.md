...
## 📺 Demos
### 1. Components implemented using the Framework
- Leaderboard Component

https://github.com/user-attachments/assets/b7ffdb03-b259-4f35-9aea-b1b500f3f7e3

- Eventposter Component

https://github.com/user-attachments/assets/9c90ff43-8217-41b3-a347-db3cb474dfa4

- Embeddedchat Component

https://github.com/user-attachments/assets/2aa4461f-ae53-4307-8394-4a2b48b94fa5

- Video conferencing Component

https://github.com/user-attachments/assets/699ac3dc-df1b-4ea0-877d-4b7fc4f83ba9

### 2. Build Pipeline Modification 
In a bid to seperate our DSL framework from our Svelte code and the components generated by it, some changes had to be made to the compiler and our `.agml` parsing methods. 

Compilation is divided into three steps:
- Extract :  Our `.agml` code is broken down and necessary data extracted  i.e Component names, data (denoted by `get` syntax) , import statements (denoted by `use`), package names and *JSX-like openings*.
- Install : Necessary packages are installed as required by the components.
- Transform: This is the code generation stage, where data items, import statements and jsx-like elements are transformed into a full-fledged Svelte Component.

To seperate our DSL framework from the code it generates, all of the Svelte code was moved into a `generatedsvelte` directory, which would contain our application (generated at the end of our compilation process). The stubbed data was moved into the `src` folder, and our other build time artifacts were moved into a `build` folder, which is to be autogenerated @ build time.

To accomodate this new structure, an `extractSourcePath` function was implemented, which performs a check to see if the data needed for the component is located in the autogenerated `build` directory, or is statically defined.
